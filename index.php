...
<head>
    ...
    <meta name="author" content="advertadd.com">

   <title>Advertadd - seo and digital marketing solution </title>
    <!-- bootstrap.min css -->
    ...
    <link type="image/x-icon" rel="shortcut icon" href="logo21.png">
...
<nav class="navbar navbar-expand-lg fixed-top trans-navigation">
        <div class="container">
            <a class="navbar-brand" href="index.php">
                <img src="logo.png" alt="" class="img-fluid b-logo" width="200">
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="mainNav">
                <ul class="navbar-nav ">
                   <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link smoth-scroll" href="service.php">Service</a>
                    </li>
                    <!-- <li class="nav-item">
                        <a class="nav-link smoth-scroll" href="pricing.php">Pricing</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-lg-8 m-auto text-center col-sm-12 col-md-12">
                        <div class="banner-content content-padding">
                            ...
                            <a href="contact.php" class="btn btn-white btn-circled">lets start</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-12 col-sm-12 ">
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                           <div class="intro-cta">
                               <p class="lead ">Still have any question on mind ? <a href="contact.php" class="smoth-scroll">Contact us</a></p>
                           </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="testimonial-content style-2">
                                            ...
                                            <p><i class="icofont icofont-quote-left"></i>This is a great platform to anyone like who want to start business but not get right decision. It’s really great place for new to start the business in right way! <i class="icofont icofont-quote-right"></i></p>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6 col-md-6">
                <div class="footer-widget footer-text">
                    <h4>Contact Us</h4>
                    <p class="mail"><span>Mail:</span> contact@advertadd.com</p>
                    <p><span>Phone :</span>+91 91467 01795</p>
                    <p><span>Location:</span> Advertadd Akole, Maharashtra , India 422601</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="footer-copy">
                    © 2021 Advertadd inc. All Rights Reserved.
                </div>
            </div>
        </div>
    </div>
...
<div class="col-lg-12 text-right">
    <div class="footer-copy">
        Designed by <a href="https://www.instagram.com/__tejas_01/">Programming Solution</a> 
    </div>
</div>
